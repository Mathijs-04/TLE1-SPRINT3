...
$experience = [
    "experience" => "Mushroom",
    "image" => "./images/mushroomforest.webp",
    "information" => "Stap in een magisch bos vol gigantische paddenstoelen en een sfeer van rust en verwondering. In deze VR-ervaring wandel je door een sprookjesachtige wereld, waar de natuur op mysterieuze wijze tot leven komt. Het zachte licht dat door de bomen valt en de vredige geluiden van het bos creëren een kalme, ontspannende omgeving. Ontdek verborgen paden en laat je verrassen door de unieke flora. Deze ervaring biedt een rustige ontsnapping naar een betoverende, natuurlijke wereld vol verrassingen.",
    "expurl" => "./mushroom.html"
];
?>
